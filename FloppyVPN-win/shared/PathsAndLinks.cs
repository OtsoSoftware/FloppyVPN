...
namespace FloppyVPN
{
	public static class PathsAndLinks
	{
		...
		public static readonly string desktopShortcutPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.CommonDesktopDirectory), "FloppyVPN.lnk");
		public static readonly string menuShortcutPath = Path.Combine(commonappDataDir, "Microsoft\\Windows\\Start Menu\\Programs", "FloppyVPN.lnk");
